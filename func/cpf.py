...
async def cpf(update: Update, context: ContextTypes.DEFAULT_TYPE, authorized_users, user_usage, DAILY_LIMIT, ADMIN_ID) -> None:
    ...
    try:
        ...
        if data.get("data") is None and data.get("status") == 401:
            ...
            logging.warning(f'Consulta retornou dados não encontrados para o nome {cpf_number} por {user_id}')
            return
        ...
        file_path = f"CPF_{cpf_number}.txt"
